    ...
    <>
      {isAptos ? (
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of PEPE rewards each farm receives, as a proportion of the PEPE produced each second."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 PEPE per second, a 40x farm would receive 40 PEPE per second.")}
          </Text>
        ...
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of PEPE rewards each farm receives, as a proportion of the PEPE produced each block."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 PEPE per block, a 40x farm would receive 40 PEPE per block.")}
          </Text>
          <Text>
            {t(
              "We have recently rebased multipliers by a factor of 10, this is only a visual change and does not affect the amount of PEPE each farm receives."
            )}
          </Text>
          <Link
            mt="8px"
