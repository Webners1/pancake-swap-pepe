...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master PEPE chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of PEPE.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's PEPE)`,
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of PepeSuperGrowSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about PepeSuperGrowSwap and more!',
]
