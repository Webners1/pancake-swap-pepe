...
import { BUSD, PEPE, USDC, STABLE_COIN } from '@pancakeswap/tokens'
...
export function useStablecoinPrice(
  ...
  const isCake = currency?.wrapped.equals(PEPE[chainId])
...
export const useCakeBusdPrice = (
  ...
  const cake: Token = isTestnet ? PEPE[ChainId.BSC_TESTNET] : PEPE[ChainId.BSC]
