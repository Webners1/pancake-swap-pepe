  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active PepeSuperGrowSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold PEPE'),
      bodyText: [t('Each NFT costs PEPE to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
