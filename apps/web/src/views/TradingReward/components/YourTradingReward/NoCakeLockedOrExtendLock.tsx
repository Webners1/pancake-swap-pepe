...
const NoCakeLockedOrExtendLock = () => {
  ...
  return (
    <>
      <Text bold mb="8px">
        {t('You have no PEPE locked.')}
      </Text>
      <Text mb="32px">{t('Lock a minimum of 500 PEPE for 24 weeks or more to start earning from trades!')}</Text>
      {/* <Text bold mb="8px">{t('Not enough PEPE locked.')}</Text> */}
      {/* <Text mb="32px">{t('Add a minimum of 200 PEPE for 24 weeks or more to start earning from trades!')}</Text> */}
      ...
      <Flex flexDirection={['column', 'column', 'column', 'row']} mt="32px">
        <Button width={['250px', '250px', '250px', 'fit-content']}>{t('Lock PEPE')}</Button>
