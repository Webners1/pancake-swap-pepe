      ...
      <Box width={['100%', '100%', '100%', '236px']} m={['0 0 24px 0', '0 0 24px 0', '0 0 24px 0', '0 48px 0 0']}>
        <GreyCard>
          <Box>
            ...
            <Balance fontSize="14px" color="textSubtle" prefix="~ " unit=" PEPE" decimals={2} value={300} />
          </Box>
        ...
        <GreyCard>
          <Box>
            <Text bold fontSize={['24px']} color="secondary">
              {t('Lock PEPE to Claim')}
            </Text>
            <Text mb="16px" fontSize="14px" color="textSubtle">
              {t('Lock a minimum of 500 PEPE for 8 weeks or more to claim rewards from trades!')}
            </Text>
            <Flex flexDirection={['column', 'column', 'column', 'row']}>
              <Flex
            ...
            <Flex flexDirection={['column', 'column', 'column', 'row']} mt="32px" alignItems="center">
              <Button width="100%">{t('Lock PEPE')}</Button>
