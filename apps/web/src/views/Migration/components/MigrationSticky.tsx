...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and PEPE</Trans>,
        subTitle: <Trans>All the earned PEPE will be harvested to your wallet upon unstake.</Trans>,
  ...
  v3: {
    title: <Trans>PepeSuperGrowSwap v3 Migration</Trans>,
    steps: [
      {
      ...
      },
      {
        ...
        subTitle: <Trans>Start earning PEPE by staking your liquidity positions to V3 Farms!</Trans>,
