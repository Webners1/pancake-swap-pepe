  ...
  return (
    <>
      <Text>
        ...
        <br />
        {t(
          'You can obtain the new token either by swapping your old tokens on PepeSuperGrowSwap or bridging them to ETH and back to BSC using the new bridge provider.',
        )}
        <br />
