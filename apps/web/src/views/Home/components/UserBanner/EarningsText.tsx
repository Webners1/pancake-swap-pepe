...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PEPE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PEPE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from PEPE pool', data)
  }
