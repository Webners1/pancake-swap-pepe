...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        PEPE up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active PepeSuperGrowSwap profile can commit. However the maximum amount of PEPE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active PepeSuperGrowSwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The PEPE from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of PEPE to either sale.</Trans>,
      <Trans>
