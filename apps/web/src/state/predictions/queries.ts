...
export const getRoundBaseFields = (tokenSymbol: string) =>
  tokenSymbol === 'PEPE' ? roundBaseFieldsCAKE : roundBaseFieldsBNB

export const getBetBaseFields = (tokenSymbol: string) => (tokenSymbol === 'PEPE' ? betBaseFieldsCAKE : betBaseFieldsBNB)

export const getUserBaseFields = (tokenSymbol: string) =>
  tokenSymbol === 'PEPE' ? userBaseFieldsCAKE : userBaseFieldsBNB
